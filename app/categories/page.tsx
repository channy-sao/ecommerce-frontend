...
import {CategoryResponse, CategoryListResponse} from "@/lib/types/category-response";
import {DataTable} from "@/app/categories/data-table";
import {columns} from "@/app/categories/column";
    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div>
                ...
                <DataTable columns={columns} data={categories} pageCount={totalPages} search={search}
