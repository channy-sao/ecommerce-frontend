...
export function EditProductDialog({ product, open, onOpenChange }: EditProductDialogProps) {
    ...
    const mutation = useMutation({
        mutationFn: (data: CreateProductSchema) => ProductApi.updateProduct(product.id, data),
        onSuccess: () => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent onInteractOutside={handleInteractOutside} className="max-w-md">
                <DialogHeader>
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                                    <div className="space-y-0.5">
                                        ...
                                        <FormDescription>Mark this product as featured to highlight it</FormDescription>
                                    </div>
                                    <FormControl>
